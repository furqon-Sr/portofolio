...
{
    protected $fillable = ['about_text', 'logo_type', 'logo_value', 'footer_name', 'footer_copyright', 'hero_title', 'hero_subtitle', 'favicon', 'favicon_type', 'profile_photo', 'resume_link'];
