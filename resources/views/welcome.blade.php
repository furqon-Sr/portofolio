        ...
        <section id="about" class="mt-40 grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div class="lg:col-span-6 space-y-8">
                <div class="space-y-4">
                    ...
                    <p class="text-gray-400 leading-relaxed text-lg">
                        I design and develop digital products focused on operational efficiency. Combining strict optical balance with maintainable code to deliver practical, logic-driven solutions.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    @php
                        $highlights = [
                            ['icon' => '<svg class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>', 'title' => 'Agency Founder', 'desc' => 'NEXA Digital for high-end clients.'],
                            ['icon' => '<svg class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 14l9-5-9-5-9 5 9 5z" /><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" /></svg>', 'title' => 'Informatics Eng.', 'desc' => 'Strong logic & architecture.'],
                            ['icon' => '<svg class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>', 'title' => 'Business Ops', 'desc' => 'Retail & systems efficiency.'],
                            ['icon' => '<svg class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>', 'title' => 'Optical Precision', 'desc' => 'Zero-pixel drift design.']
                        ];
                    @endphp
                    @foreach($highlights as $item)
                        <div class="p-5 bg-[#1a1a1a] border border-gray-800 rounded-xl hover:border-blue-500/50 transition-colors group">
                            <div class="mb-3 group-hover:scale-110 transition-transform">{!! $item['icon'] !!}</div>
            ...
            <div class="lg:col-span-6">
                ...
                <div class="grid grid-cols-4 gap-4">
                    @php
                        $stack = [
                            ['name' => 'Laravel', 'logo' => 'Laravel.jpg', 'bg' => 'bg-[#FF2D20]/10', 'border' => 'hover:border-[#FF2D20]', 'url' => 'https://laravel.com'],
                            ['name' => 'Node.js', 'logo' => 'nodejs.png', 'bg' => 'bg-[#339933]/10', 'border' => 'hover:border-[#339933]', 'url' => 'https://nodejs.org'],
                            ['name' => 'JS', 'logo' => 'javascript.png', 'bg' => 'bg-white', 'border' => 'hover:border-[#F7DF1E]', 'url' => 'https://developer.mozilla.org'],
                            ['name' => 'Java', 'logo' => 'java.png', 'bg' => 'bg-white', 'border' => 'hover:border-blue-500', 'url' => 'https://www.java.com'],
                            ['name' => 'PHP', 'logo' => 'php.png', 'bg' => 'bg-[#777BB4]/10', 'border' => 'hover:border-[#777BB4]', 'url' => 'https://www.php.net'],
                            ['name' => 'MySQL', 'logo' => 'mysql.png', 'bg' => 'bg-white', 'border' => 'hover:border-blue-500', 'url' => 'https://www.mysql.com'],
                            ['name' => 'Figma', 'logo' => 'figma.png', 'bg' => 'bg-[#F24E1E]/10', 'border' => 'hover:border-[#F24E1E]', 'url' => 'https://www.figma.com'],
                            ['name' => 'Tailwind', 'logo' => 'tailwindd.png', 'bg' => 'bg-[#06B6D4]/10', 'border' => 'hover:border-[#06B6D4]', 'url' => 'https://tailwindcss.com'],
                            ['name' => 'Adobe AI', 'logo' => 'ai.svg', 'bg' => 'bg-[#FF9A00]/10', 'border' => 'hover:border-[#FF9A00]', 'url' => 'https://www.adobe.com/products/illustrator.html'],
                            ['name' => 'Photoshop', 'logo' => 'ps.svg', 'bg' => 'bg-[#31A8FF]/10', 'border' => 'hover:border-[#31A8FF]', 'url' => 'https://www.adobe.com/products/photoshop.html'],
                        ];
                    @endphp

                    @foreach($stack as $tech)
                        <a href="{{ $tech['url'] }}" target="_blank" class="{{ $tech['bg'] }} {{ $tech['border'] }} aspect-square rounded-xl flex items-center justify-center border border-gray-800 group transition-all duration-300 overflow-hidden relative">
                            <img src="{{ asset('img/logos/' . $tech['logo']) }}" 
                                alt="{{ $tech['name'] }}" 
                                class="w-full h-full {{ in_array($tech['name'], ['JS', 'Java', 'MySQL']) ? 'object-contain p-2' : 'object-cover' }}">
                            <div class="absolute inset-0 opacity-0 group-hover:opacity-20 {{ $tech['bg'] }} transition-opacity"></div>
                        </a>
                    @endforeach
                </div>
            </div>
