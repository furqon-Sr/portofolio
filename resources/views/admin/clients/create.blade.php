...
<div class="mb-8 flex items-center gap-4">
    ...
    <h1 class="text-3xl font-bold tracking-tighter text-white">Add New Client</h1>
</div>

<div class="bg-gray-900 border border-white/10 rounded-2xl p-6 md:p-8 max-w-3xl">
    <form action="{{ route('admin.clients.store') }}" method="POST" x-data="{ logoPreview: '' }">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" required class="w-full bg-gray-950 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors" placeholder="e.g. Google, Vercel, Startup Inc">
            </div>
            ...
            <div>
                ...
                <input type="number" name="order_index" value="0" class="w-full bg-gray-950 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors">
            </div>
            ...
            <div>
                ...
                <div class="flex items-start gap-6">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 mt-2">Upload a transparent PNG, or SVG format for best results.</p>
                    </div>
