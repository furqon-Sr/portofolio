...
<div class="group block bg-[#111111]/40 border border-gray-800/60 rounded-2xl p-4 transition-all duration-500 hover:border-blue-500/40 hover:shadow-2xl hover:shadow-blue-500/5">
    
    <!-- Clickable Image Area -->
    <a href="{{ $link }}" target="_blank" class="block aspect-[16/10] bg-[#1a1a1a] border border-gray-800/80 rounded-xl overflow-hidden relative mb-4 transition-all duration-500 group-hover:border-blue-500/30">
        @if($image)
    ...
    <div class="space-y-2">
        <div class="flex items-start justify-between gap-2">
            <a href="{{ $link }}" target="_blank" class="hover:text-blue-500 transition-colors">
        ...
        <div class="flex items-center gap-4 pt-3 mt-3 border-t border-white/5 text-[10px] md:text-xs font-semibold">
            ...
            <a href="{{ $link }}" target="_blank" class="text-white hover:text-blue-500 flex items-center gap-1.5 transition-colors">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                Website
            </a>
            <!-- Pilihan 2: Ke GitHub -->
            @if($github_link)
            <a href="{{ $github_link }}" target="_blank" class="text-gray-400 hover:text-white flex items-center gap-1.5 transition-colors">
        ...
        <!-- Design Links -->
        <div class="flex items-center gap-4 pt-3 mt-3 border-t border-white/5 text-[10px] md:text-xs font-semibold">
            <a href="{{ $link }}" target="_blank" class="text-white/80 hover:text-blue-500 flex items-center gap-1.5 transition-colors">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                View Design
            </a>
        </div>
